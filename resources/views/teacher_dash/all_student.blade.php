			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="row clearfix">
						...
						<div class="pd-20">
							<h4 class="text-blue h4">{{Auth::user()->class_one}} Details</h4>
							...
							<div class="pull-right">
								<a
									...
									><i class="fa fa-check"></i> Mark Attendance</a>
...
<!-- class two ------------------------------------------------------------------------->
           @if(Auth::user()->class_two)
										<div class="tab-pane fade" id="classtwo" role="tabpanel">
											...
											<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">{{Auth::user()->class_two}} Details</h4>
...
<!-- class three ------------------------------------------------------------------------->
   @if(Auth::user()->class_three)
										<div class="tab-pane fade" id="classthree" role="tabpanel">
											...
											<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">{{Auth::user()->class_three}} Details</h4>
   ...
   @if(Auth::user()->class_four)
										<div class="tab-pane fade" id="classfour" role="tabpanel">
											...
											<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">{{Auth::user()->class_four}} Details</h4>
   ...
   @if(Auth::user()->class_five)
										<div class="tab-pane fade" id="classfive" role="tabpanel">
											...
											<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">{{Auth::user()->class_five}} Details</h4>
   ...
   @if(Auth::user()->class_six)
										<div class="tab-pane fade" id="classsix" role="tabpanel">
											...
											<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">{{Auth::user()->class_six}} Details</h4>
   ...
   @if(Auth::user()->class_seven)
										<div class="tab-pane fade" id="classseven" role="tabpanel">
											...
											<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">{{Auth::user()->class_seven}} Details</h4>

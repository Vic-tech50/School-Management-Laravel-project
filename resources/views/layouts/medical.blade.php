		...
		<div class="header">
			...
			<div class="header-right">
				...
				<div class="github-link">
					<a href="https://victech.ng" target="_blank"
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li class="dropdown">
							<a href="{{route('medical.home')}}" class="dropdown-toggle no-arrow">
							...
							<li class="dropdown">
							<a href="/add_patient" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-people"></span
								><span class="mtext">Add Patient</span>
							</a>
							...
							<a href="{{route('patient.index')}}" class="dropdown-toggle no-arrow">
								...
								><span class="mtext">Medical History</span>
							</a>
						</li>
						...
						<li>
							...
							<ul class="submenu">
								<li><a href="{{route('medical.profile')}}">Profile</a></li>

				...
				<div class="header-search">
					<form>
						<div class="form-group mb-0">
							<i class="dw dw-search2 search-icon no-print" ></i>
							<input
								type="text"
				...
				<div class="user-notification">
					<div class="dropdown">
						<a
							...
							data-toggle="dropdown"
						>
							<i class="icon-copy dw dw-notification no-print"></i>
							@if($ct > 1)
					...
					<div class="dropdown">
						...
						>
							<span class="user-icon">
								<img src="{{ asset('uploads/students')}}/{{Auth::user()->passport}}" alt="image" style="height: 100%" />
							</span>
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li class="dropdown">
							...
							<li class="dropdown">
							<a href="{{route('student.attendance')}}" class="dropdown-toggle no-arrow">
							...
							<li>
							<a href="student_	result" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-upload"></span
								><span class="mtext">Grade</span>
							</a>
						</li>

						
							<li>
							<a href="{{route('student.assignments')}}" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-book"></span
								><span class="mtext">Submit Assignment</span>
							</a>
						</li>
							...
							<li>
							<a href="{{route('student.notice')}}" class="dropdown-toggle no-arrow">

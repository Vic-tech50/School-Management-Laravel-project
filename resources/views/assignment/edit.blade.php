...
<div class="main-container">
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
						 ...
						 <form class="container"  action="{{route('assignment.update', $assignment->id)}}" method="post" enctype="multipart/form-data">
                                                  @csrf
                                                  @method('PUT')
							...
							<div class="form-group">
								...
								<input
									type="text"
									class="form-control-file form-control height-auto" value = "{{$assignment->title}}"  name = "title"
									 required
								/>
							</div>
							...
							<div class="form-group">
								...
								<input
									type="date"
									class="form-control-file form-control height-auto" value = "{{$assignment->end_date}}" name = "end_date"
							...
							<div class="form-group">
								...
								<input
									type="time"
									class="form-control-file form-control height-auto" name = "end_time" value = "{{$assignment->end_time}}"
				...
				<option value="{{$assignment->class}} {{$assignment->subject}}">{{$assignment->class}} -  {{$assignment->subject}}</option>
				...
				@endif
							...
							<div class="form-group">
								...
								<select class="custom-select col-12" name = "type"  required style="text-transform: uppercase;">
					<option value="{{$assignment->type}}" selected >{{$assignment->type}}</option>
  ...
  <div>
   <div class="form-group">
								...
								<textarea id="space" class="form-control" name = "description">{{$assignment->description}}</textarea>
							</div>
  </div>
